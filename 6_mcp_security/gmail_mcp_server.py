...
# Guardar token para el cliente en un archivo
with open(ROOT_DIR / "client_token.txt", "w") as token_file:
    token_file.write(client_token)

print(
    f"Token para el cliente generado y guardado en 'client_token.txt':\n{client_token[:50]}\n"
)
